...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="" style="text-decoration:none"class="un logo"><b>FarmHands</b></a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="inline">
                        <!-- Menu Toggle Button -->
                        <a href="<?php echo site_url('Volunteer/logout') ?>"> <i class="fa fa-sign-out"></i>
                            Log out </a>
    ...
    <?php $this->load->view('volunteer/navigation_bar');?>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <section class="content">
                                ...
                                <?php $this->load->view('volunteer/content');?>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>&copy; 2017 FarmHands  &middot; <a href="<?php echo base_url();?>About">About</a> &middot; <a href="<?php echo base_url(); ?>Blog">Blog</a> &middot; <a href="#">Privacy Policy</a> &middot; <a href="#">Terms</a>
