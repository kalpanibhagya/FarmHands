...
<form class="form-horizontal" id="dataCryo" method="post" enctype="multipart/form-data">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <h5 class="col-sm-6 "><?php echo $data->fname; ?></h5>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <h5 class="col-sm-6 "><?php echo $data->lname; ?></h5>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <h5 class="col-sm-6 "><?php echo $data->telephone; ?></h5>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#butangBack').unbind('click').click(function () {
            $.ajax({
                url : "<?php echo base_url();?>Farmer/volunteers",
