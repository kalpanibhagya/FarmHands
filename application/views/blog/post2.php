...
<!-- single -->
	<div class="single-page-artical">
		<div class="artical-content">
			<h3 style="text-align: center;">Organic Fruits</h3>
			<img class="img-responsive" src="<?php echo base_url(); ?>assets/images/posts/organic_fruits_and_vegetables.jpg" alt="hh " />
			<p><b>A newly launched modern farming company, Bowery, is growing what they call the world’s first “post-organic” produce. Their concept breaks from traditional agricultural practices by growing plants indoors in vertical rows without any pesticides. With the help of proprietary technology, Bowery can closely monitor the growth of their crops and meticulously manage the resources needed. More than 80 types of crops are currently being grown at the company’s farm in Kearny, New Jersey, and they are selling several types of greens and herbs in stores in the New York region.</b>
			</p>
			<p><b>
				The idea for the company spawned when co-founder and CEO Irving Fain discovered a promising trend in LED lighting cost and efficiency that could improve indoor farming. “The pricing of LED lights dropped dramatically a little over 5 years ago,” Fain says. “We’ve also seen the efficiency more than double. What makes this even more exciting is that research suggests that this trend will continue. This means that not only are LED’s a viable solution for indoor farming today, but this solution continues to scale out in the future.”</b>
			</p>
			<p><b>
				“While traditional farming methods waste resources and endanger our future food supply, advancements in indoor farming make it possible to address a wide range of agricultural issues,” Fain adds. He teamed up with co-founders David Golden and Brian Falther to start Bowery.</b>
			</p>
		</div>
